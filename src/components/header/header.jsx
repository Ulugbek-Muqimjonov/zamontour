...
import burgerBtn from "../../assets/images/burgerbtn.png";
import telegramlogo from "../../assets/images/1.png";
import {
  Sheet,
  SheetContent,
  SheetDescription,
          ...
          <div>
            <Sheet className="px-0">
              ...
              <SheetContent className="px-0">
                <SheetDescription className="dropdown-text text-center py-3 border mt-4">
                  Home
                </SheetDescription>
                <SheetDescription className="dropdown-text text-center py-3 border">
                  About
                </SheetDescription>
                <SheetDescription className="dropdown-text text-center py-3 border">
                  Contacts
                ...
                <SheetDescription className="dropdown-text text-center p-3 border">
                  RU
                </SheetDescription>
                <SheetDescription className="dropdown-text flex justify-center p-3 border">
                  <svg
